Cerebralcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/cerebralcoin/files/Cerebralcoin/cerebralcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Cerebralcoin
...
New/changed settings (command-line or cerebralcoin.conf file)
--------------------------------------------------------
