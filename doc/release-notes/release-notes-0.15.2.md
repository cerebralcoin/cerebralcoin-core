Cerebralcoin Core version *0.15.2* is now available from:

  <https://cerebralcoincore.org/bin/cerebralcoin-core-0.15.2/>
...
Cerebralcoin Core versions 0.14.0 up to 0.16.2. It is recommended to upgrade any of
...
- #11554 `a69cc07` Sanity-check script sizes in cerebralcoin-tx (TheBlueMatt)
