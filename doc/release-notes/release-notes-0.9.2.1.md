Cerebralcoin Core version 0.9.2.1 is now available from:

  https://cerebralcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 CEB to 0.01 CEB
...
- Fix "Start cerebralcoin on system login"
