Cerebralcoin Core version 0.9.4 is now available from:

  https://cerebralcoin.org/bin/0.9.4/
...
this update is incompatible with the Cerebralcoin system and could lead to consensus
forks.

Cerebralcoin Core released binaries from https://cerebralcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~cerebralcoin/+archive/ubuntu/cerebralcoin
- A third-party or self-compiled Cerebralcoin Core

upgrade to Cerebralcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
