Cerebralcoin Core version 0.13.2 is now available from:

  <https://cerebralcoin.org/bin/cerebralcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update cerebralcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow cerebralcoin-tx to create v2 transactions (btcdrak)
