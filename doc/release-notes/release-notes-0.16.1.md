Cerebralcoin Core version 0.16.1 is now available from:

  <https://cerebralcoincore.org/bin/cerebralcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting cerebralcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure cerebralcoind processes are cleaned up when tests end (sdaftuar)
