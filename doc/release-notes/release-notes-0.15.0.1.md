Cerebralcoin Core version *0.15.0.1* is now available from:

  <https://cerebralcoin.org/bin/cerebralcoin-core-0.15.0.1/>

and

  <https://cerebralcoincore.org/bin/cerebralcoin-core-0.15.0.1/>
