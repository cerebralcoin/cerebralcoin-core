Cerebralcoin Core version 0.10.4 is now available from:

  <https://cerebralcoin.org/bin/cerebralcoin-core-0.10.4/>
...
- #6953 `43c2789` Split cerebralcoin-tx into its own package
- #6953 `dfe0d4d` Include cerebralcoin-tx binary on Debian/Ubuntu
