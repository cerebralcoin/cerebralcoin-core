...
This document provides guidelines for internationalization of the Cerebralcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `cerebralcoin_en.ts` remains unchanged.
