Fuzz-testing Cerebralcoin Core
==========================
...
```
git clone https://github.com/cerebralcoin-core/qa-assets
...
To build Cerebralcoin Core using AFL instrumentation (this assumes that the
