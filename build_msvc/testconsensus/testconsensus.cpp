...
// cerebralcoin includes.
#include <..\src\script\cerebralcoinconsensus.h>
...
int main()
{
    std::cout << "cerebralcoinconsensus version: " << cerebralcoinconsensus_version() << std::endl;
    ...
    auto op0Result = cerebralcoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, cerebralcoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
