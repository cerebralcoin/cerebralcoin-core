 ...
 */
#ifndef CEREBRALCOIN_UTIL_SYSTEM_H
#define CEREBRALCOIN_UTIL_SYSTEM_H
...
extern const char * const CEREBRALCOIN_CONF_FILENAME;
...
{
    std::string s = strprintf("cerebralcoin-%s", name);
...
#endif // CEREBRALCOIN_UTIL_SYSTEM_H
