...
#ifndef CEREBRALCOIN_VALIDATION_H
#define CEREBRALCOIN_VALIDATION_H
...
static const int64_t DEFAULT_MAX_TIP_AGE = 24 * 60 * 60* 4000;//24 * 60 * 60;
...
#endif // CEREBRALCOIN_VALIDATION_H
