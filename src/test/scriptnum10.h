...
#ifndef CEREBRALCOIN_TEST_SCRIPTNUM10_H
#define CEREBRALCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Cerebralcoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // CEREBRALCOIN_TEST_BIGNUM_H
