...
{
    BOOST_CHECK(TestSplitHost("www.cerebralcoincore.org", "www.cerebralcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.cerebralcoincore.org]", "www.cerebralcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.cerebralcoincore.org:80", "www.cerebralcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.cerebralcoincore.org]:80", "www.cerebralcoincore.org", 80));
