...
#ifndef CEREBRALCOIN_KEYSTORE_H
#define CEREBRALCOIN_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/cerebralcoin/bips/blob/master/bip-0013.mediawiki
