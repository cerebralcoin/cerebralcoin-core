...
static void SetupCerebralcoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " cerebralcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  cerebralcoin-tx [options] <hex-tx> [commands]  Update hex-encoded cerebralcoin transaction\n" +
            "or:     cerebralcoin-tx [options] -create [commands]   Create hex-encoded cerebralcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cerebralcoin transaction
