...
#ifndef CEREBRALCOIN_QT_SPLASHSCREEN_H
#define CEREBRALCOIN_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. Cerebralcoin Core initialization
...
#endif // CEREBRALCOIN_QT_SPLASHSCREEN_H
