...
#ifndef CEREBRALCOIN_QT_CEREBRALCOINUNITS_H
#define CEREBRALCOIN_QT_CEREBRALCOINUNITS_H
...
/** Cerebralcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class CerebralcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit CerebralcoinUnits(QObject *parent);

    /** Cerebralcoin units.
      @note Source: https://en.cerebralcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        CEB,
...
typedef CerebralcoinUnits::Unit CerebralcoinUnit;

#endif // CEREBRALCOIN_QT_CEREBRALCOINUNITS_H
