...
//! Entry point for CerebralcoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &CerebralcoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for CerebralcoinGUI tests.
void AppTests::guiTests(CerebralcoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &CerebralcoinGUI::consoleShown, this, &AppTests::consoleTests);
