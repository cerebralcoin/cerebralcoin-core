    ...
    mapper(nullptr)
{
    ...
    ui->cerebralcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->cerebralcoinAtStartup);
    ...
    ui->cerebralcoinAtStartup->setToolTip(ui->cerebralcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->cerebralcoinAtStartup->setText(ui->cerebralcoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openCerebralcoinConfButton->setToolTip(ui->openCerebralcoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new CerebralcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->cerebralcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openCerebralcoinConfButton_clicked()
{
    ...
    if (!GUIUtil::openCerebralcoinConf())
