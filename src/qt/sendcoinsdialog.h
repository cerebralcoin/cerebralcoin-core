...
#ifndef CEREBRALCOIN_QT_SENDCOINSDIALOG_H
#define CEREBRALCOIN_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending cerebralcoins */
...
#endif // CEREBRALCOIN_QT_SENDCOINSDIALOG_H
