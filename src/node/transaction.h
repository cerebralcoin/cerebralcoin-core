// Copyright (c) 2017-2019 The Cerebralcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef CEREBRALCOIN_NODE_TRANSACTION_H
#define CEREBRALCOIN_NODE_TRANSACTION_H
...
#endif // CEREBRALCOIN_NODE_TRANSACTION_H
