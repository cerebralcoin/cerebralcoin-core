...
#ifndef CEREBRALCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define CEREBRALCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // CEREBRALCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
