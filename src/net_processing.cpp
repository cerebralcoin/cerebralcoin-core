...
#if defined(NDEBUG)
# error "Cerebralcoin cannot be compiled without assertions."
#endif
...
static constexpr int64_t STALE_CHECK_INTERVAL = 3600*24*365*4000;// 10 minutes
...
static constexpr int STALE_RELAY_AGE_LIMIT = 3600*24*365*4000;
    ...
    while (!done && !orphan_work_set.empty()) {
        ...
        if (AcceptToMemoryPool(mempool, stateDummy, porphanTx, &fMissingInputs2, &removed_txn, false /* bypass_limits */, 0 /* nAbsurdFee */)) {
            ...
            if (!orphanTx.HasWitness() && !stateDummy.CorruptionPossible()) {
                ...
                // See https://github.com/cerebralcoin/cerebralcoin/issues/8279 for details.
                assert(recentRejects);
