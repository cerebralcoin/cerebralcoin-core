...
#ifndef CEREBRALCOIN_WALLET_WALLET_H
#define CEREBRALCOIN_WALLET_WALLET_H
...
enum WalletFlags : uint64_t {
    ...
    //! cerebralcoin from opening the wallet, thinking it was newly created, and
...
public:
     ...
     * on this cerebralcoin node, and set to 0 for transactions that were created
...
#endif // CEREBRALCOIN_WALLET_WALLET_H
