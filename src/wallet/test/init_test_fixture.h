...
#ifndef CEREBRALCOIN_WALLET_TEST_INIT_TEST_FIXTURE_H
#define CEREBRALCOIN_WALLET_TEST_INIT_TEST_FIXTURE_H
...
#endif // CEREBRALCOIN_WALLET_TEST_INIT_TEST_FIXTURE_H
