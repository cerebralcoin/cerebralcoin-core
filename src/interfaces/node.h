...
#ifndef CEREBRALCOIN_INTERFACES_NODE_H
#define CEREBRALCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a cerebralcoin node (cerebralcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // CEREBRALCOIN_INTERFACES_NODE_H
