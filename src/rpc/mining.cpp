...
static UniValue getblocktemplate(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() > 1)
        throw std::runtime_error(
            RPCHelpMan{"getblocktemplate",
                ...
                "    https://github.com/cerebralcoin/bips/blob/master/bip-0022.mediawiki\n"
                "    https://github.com/cerebralcoin/bips/blob/master/bip-0023.mediawiki\n"
                "    https://github.com/cerebralcoin/bips/blob/master/bip-0009.mediawiki#getblocktemplate_changes\n"
                "    https://github.com/cerebralcoin/bips/blob/master/bip-0145.mediawiki\n",
                {
    ...
    if (g_connman->GetNodeCount(CConnman::CONNECTIONS_ALL) == 0)
        throw JSONRPCError(RPC_CLIENT_NOT_CONNECTED, "Cerebralcoin is not connected!");

    if (IsInitialBlockDownload())
    	printf("commentd out for intital block");
        //throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "Cerebralcoin is downloading blocks...");
