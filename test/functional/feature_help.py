...
"""Verify that starting cerebralcoin with -h works as expected."""

from test_framework.test_framework import CerebralcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(CerebralcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start cerebralcoin with -h for help text")
        ...
        self.log.info("Start cerebralcoin with -version for version information")
        ...
        self.log.info("Start cerebralcoind with -fakearg to make sure it does not start")
