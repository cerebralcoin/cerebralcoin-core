...
# TestP2PConn: A peer we use to send messages to cerebralcoind, and store responses.
...
class CompactBlocksTest(CerebralcoinTestFramework):
    ...
    # This test actually causes cerebralcoind to (reasonably!) disconnect us, so do this last.
    ...
    # cerebralcoind's choice of nonce.
    ...
    # Test that cerebralcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for cerebralcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # cerebralcoind will not send blocktxn responses for blocks whose height is
